...
exports.BatchedAccumulator = void 0;
/**
...
class BatchedAccumulator {
    constructor(_batchSize) {
        ...
        if (!isNaturalNumber(this._batchSize)) {
            // prettier-ignore
            throw new Error(`${BatchedAccumulator.name} expects a natural number for ` +
...
exports.BatchedAccumulator = BatchedAccumulator;
...
//# sourceMappingURL=batched-items-accumulator.js.map